  ...
  defaultDbSettings
    `withDbModification` dbModification
      { _appDb_users = setEntityName "users",
        ...
        _appDb_flowerChatRoom =
          (dbModification @_ @_ @(ChatRoomT FlowerRoom UserT))
            { _chat_messages =
                setEntityName "flowers_chat_messages"
                  <> modifyTableFields tableModification {_message_sentAt = fieldNamed "sent_at"},
              _chat_likes = setEntityName "flowers_chat_likes"
            },
        _appDb_userChatRoom =
          (dbModification @_ @_ @(ChatRoomT UserRoom UserT))
            { _chat_messages =
                setEntityName "users_chat_messages"
                  <> modifyTableFields tableModification {_message_sentAt = fieldNamed "sent_at"},
              _chat_likes = setEntityName "users_chat_likes"
            },
        _appDb_complianceChatRoom =
          (dbModification @_ @_ @(ChatRoomT FlowerAuditRoom ComplianceOfficerT))
            { _chat_messages =
                setEntityName "auditors_chat_messages"
                  <> modifyTableFields tableModification {_message_sentAt = fieldNamed "sent_at"},
...
annotatedDB =
  defaultAnnotatedDbSettings appDB
    `withDbModification` dbModification
      { _appDb_flowerChatRoom =
          dbModification
            { _chat_messages =
